...
public class SetService {
	...
	public void method1() {
		...
		// 6. boolean isEmpty() : Set이 비어있으면 true, 비어있지 않으면 false
	...
	public void method2() {
		...
		System.out.println("[Iterator로 순차 접근]");
		System.out.println(set);
	...
	public void method3() {
		...
		// hashCode(), equals() 오버라이딩 필수적으로 진행되어야함
		// ********************************************************
	...
	public void method4() {
		...
		// ex) Random.nextInt(10) : 0~9 범위 내 정수를 랜덤 반환
	...
	public void lottoNumberGenerator() {
		...
		// for문이 반복될 때마다 새로운 TreeSet 객체 생성
		for(int i=0; i<amount/1000; i++) {
			...
			while(lotto.size()<6) {
				lotto.add(random.nextInt(45) + 1); // 1 ~ 45 사이 난수 생성
			}
			lottolist.add(lotto);
		}
