package edu.kh.ploy.ex2.run;

import edu.kh.ploy.ex2.model.service.AbstractService;
import edu.kh.ploy.ex2.model.service.Calculator;
import edu.kh.ploy.ex2.model.service.HJHCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		Calculator cal = new HJHCalculator();
		...
		// 코드의 큰 수정 없이
		// 객체 생성 코드만 바꾸면 새로운 클래스를 수행할 수 있다.
		...
		// 2) 자식 클래스에 공통된 메서드를 강제 구현해야하기 때문에
		//    모든 자식 클래스가 동일한 형태를 가지게 된다.
		//    -> 이를 이용하여 공동작업(협업, 팀프로젝트)에 필요한
		//       개발환경 조성에 용이하다.
	}
